...
import { MapPin, Bed, Bath, Ruler, Car, ChevronLeft, ChevronRight, ChevronDown, ChevronUp, Images } from "lucide-react"
...
export function MultimodalPropertyCard({ property, index }: MultimodalPropertyCardProps) {
  ...
  return (
    ...
    >
      <Card className="bg-card border-border hover:border-primary/30 transition-colors overflow-hidden flex flex-col">
        {/* Image carousel — fixed aspect ratio, placeholder if no images */}
